...
class VenueForm(Form):
    ...
    state = SelectField(
        'state', validators=[DataRequired(), Length(max=120)], choices=state_picks
    )
    address = StringField(
    ...
    genres = SelectMultipleField(
        ...
        'genres', validators=[DataRequired()], choices=genre_picks
    )
...
class ArtistForm(Form):
    ...
    state = SelectField(
        'state', validators=[DataRequired()], choices=state_picks
    )
    phone = StringField(
